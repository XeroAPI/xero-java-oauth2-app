...
public class ProcessingCamtFile extends HttpServlet {
    ...
    try {
        ...
        File stylesheet = new File("/home/descartes/eclipse/workspace/xero-swiss-camt05x-converter-java/src/com/xero/converter/process.xsl");
        System.out.println("Premier fichier lu");
        File xmlSource = new File("/home/descartes/eclipse/workspace/xero-swiss-camt05x-converter-java/src/com/xero/converter/camt.053.xml");
        ...
        Result outputTarget = new StreamResult(new File("/home/descartes/Desktop/x.csv"));
